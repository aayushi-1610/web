...
import './styles.css'; // Make sure this CSS file is in the same folder as your component
  ...
  useEffect(() => {
    class Tree {
      ...
      draw() {
        ...
        // Define brown color
        const branchColor = this.darkTheme ? 'saddlebrown' : 'saddlebrown';
        const fruitColor = this.darkTheme ? 'darkgreen' : 'darkgreen';
        ...
        branches.forEach(b => {
          ...
          c.strokeStyle = branchColor; // Set branch color here
          c.beginPath();
          c.moveTo(b.x1, b.y1);
          c.lineTo(
