...
export  const Linkedin = (props) => (
  ...
  data-prefix="fab"
  data-icon="linkedin"
  class="prefix__svg-inline--fa prefix__fa-linkedin prefix__fa-w-16"
  xmlns="http://www.w3.org/2000/svg"
  viewBox="0 0 448 512"
  {...props}
>
  <path
    fill={props.fill}
    d="M100.3 448H7.6V149.7h92.7zM53.9 124.4C24.1 124.4 0 100.3 0 70.6 0 40.8 24.1 16 53.9 16s53.9 24.1 53.9 54.6c.3 30.3-24 54.5-53.9 54.5zm344.1 323.6h-92.6V304.6c0-34.8-.7-79.6-48.4-79.6-48.5 0-55.9 37.9-55.9 77.1v146.9H160.8V149.7h90.8v41.1h1.3c12.6-24 43.4-49.5 89.5-49.5 95.7 0 113 62.9 113 144.8v163.7zM448 0H0v512h448V0z"
  /></svg>)
